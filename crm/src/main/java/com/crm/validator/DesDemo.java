...
public class DesDemo {
	...
	public static void main(String[] args) {
		String data=DesDemo.decrypt("+5KebwAzIOQxRlgaRkhvYA9x3Yf+3v07THXeKl5mj3FSiasZs/lLAec4xJ7+r0CI8NhtuH2vIyOESdsrP3Ti5I3XLbRC2R1o", "YKJ_KHZX_01");
	...
	public byte[] decrypt(byte[] arrB) throws IllegalBlockSizeException, BadPaddingException {
		byte[] s = decryptCipher.doFinal(arrB);
		return s;
	}
	...
	public static DesDemo getDes(String strKey) {
		DesDemo des = null;
		try {
			des = new DesDemo(strKey);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return des;
